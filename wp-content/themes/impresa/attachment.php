...
<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
				...
				<?php if ( ! empty( $post->post_parent ) ) : ?>
					<p class="page-title"><a href="<?php echo get_permalink( $post->post_parent ); ?>" title="<?php esc_attr( printf( __( 'Return to %s', 'templatesquare' ), get_the_title( $post->post_parent ) ) ); ?>" rel="gallery"><?php
...
<?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'templatesquare' ) ); ?>
