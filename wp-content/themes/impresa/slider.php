			...
			<div style="background: #fff; opacity: .8; position: absolute; top: 0px; left: 690px; padding: 0px; margin: 20px; width: 200px; z-index: 100;">
				...
				<div style="padding: 15px 15px 0 15px;">
					...
					<div style="margin: 10px 0 15px 0;">
						<a href="##" id="patientPortal" style="padding: 4px 8px; background: #66b451; border: 1px solid #5daa48; color: #fff; font-weight: bold; text-transform: uppercase; font-size: 10px;-webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px;">get started</a>
					</div>
				</div>
			</div>
			</div>			
...
<script>
 $(function(){
 	$("a#patientPortal").click(function(e){
		alert("Oops, this functionality is not quite ready!\nI'm waiting on MedFusion to get back to me");
		e.preventDefault();
	});
 });
</script>